...
<main class="main-content">
    <header class="dashboard-header">
        <h1>Manage Notes / Resources</h1>
        <button class="add-btn"><i class="fas fa-upload"></i> Upload New Note</button>
    </header>

    <!-- ===== SEARCH & FILTER ===== -->
    <section class="search-filter">
        <input type="text" id="searchInput" placeholder="Search by title, course, or teacher..." onkeyup="searchTable()">
...
<script>
    ...
    function searchTable() {
        ...
        for (let i = 1; i < rows.length; i++) {
            ...
            let match = false;
            for (let j = 1; j < 4; j++) { // Title, Course, Uploaded By
