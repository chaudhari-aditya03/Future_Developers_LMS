...
<main class="main-content">
    <header class="dashboard-header">
        ...
        <button class="add-btn"><i class="fas fa-plus-circle"></i> Add New Test</button>
    </header>

    <!-- ===== SEARCH & FILTER ===== -->
    <section class="search-filter">
        <input type="text" id="searchInput" placeholder="Search by test title, course, or teacher..." onkeyup="searchTable()">
...
<script>
    ...
    function searchTable() {
        ...
        for (let i = 1; i < rows.length; i++) {
            ...
            let match = false;
            for (let j = 1; j < 4; j++) { // Test Title, Course, Teacher
