...
<main class="main-content">
    <header class="dashboard-header">
        ...
        <button class="add-btn"><i class="fas fa-plus-circle"></i> Add Lecture</button>
    </header>

    <!-- ===== SEARCH & FILTER ===== -->
    <section class="search-filter">
        <input type="text" id="searchInput" placeholder="Search by student, course, or lecture..." onkeyup="searchTable()">
...
<script>
    ...
    function searchTable() {
        ...
        for (let i = 1; i < rows.length; i++) {
            ...
            let match = false;
            for (let j = 1; j < 5; j++) { // Lecture Name, Course, Student ID, Student Name
    ...
    function filterStatus() {
        ...
        for (let i = 1; i < rows.length; i++) {
            let status = rows[i].getElementsByTagName("td")[5].getElementsByTagName("select")[0].value;
